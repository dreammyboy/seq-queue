...
const STATUS_IDLE = 0;      //Queue status: idle, welcome new tasks
const STATUS_BUSY = 1;      //Queue status: busy, queue is working for some tasks now
const STATUS_CLOSED = 2;    //Queue status: closed, queue has closed and would not receive task any more and is processing the remaining tasks now.
const STATUS_DRAINED = 3;   //Queue status: drained, queue is ready to be destroy
